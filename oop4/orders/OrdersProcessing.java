...
public class OrdersProcessing {
    ...
    public static void main(String[] args) {
        ...
        OnlineOrder onlineOrderNew =  new OnlineOrder(OrderStatus.NEW, PaymentType.CREDIT_CARD, 10);
        OnlineOrder onlineOrderProcessing =  new OnlineOrder(OrderStatus.PROCESSING, PaymentType.CREDIT_CARD, 10);
        Order [] orders = {onlineOrderNew,onlineOrderProcessing  };
        ReportPrinter reportPrinter = new  ReportPrinter ();
        reportPrinter.printReport(orders);
    }
}